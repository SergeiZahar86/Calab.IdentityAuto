using Calab.IdentityAuto.Core;
using Calab.IdentityAuto.Web.AppStart.ConfigureServices;
using Calab.IdentityAuto.Web.Infrastructure.Auth;
using Calab.IdentityAuto.Web.Middlewares;
...
namespace Calab.IdentityAuto.Web.AppStart.Configures
{
    /// <summary>
